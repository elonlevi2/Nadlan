...
urlpatterns = [
    ...
    # path("properties_sale/<str:action>/<str:rooms>/<str:city>/<str:balcony>/<str:price>",
    #      api_views.PropertyApiPagination.as_view(), name='properties_sale'),
    path("properties_sale/<str:action>", api_views.PropertyApiPagination.as_view(), name='properties_sale'),
